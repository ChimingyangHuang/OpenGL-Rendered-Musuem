...
// ********************
//source:https://www.designwizard.com/blog/design-trends/colour-combination
float colors[6][2][3]  = {
    148.0 / 255.0,147.0 / 255.0,152.0 / 255.0,            244.0 / 255.0,223.0 / 255.0,78.0 / 255.0,
    252.0 / 255.0,118.0 / 255.0,106.0 / 255.0,            91.0 / 255.0,132.0 / 255.0, 177.0 / 255.0,
    95.0 / 255.0, 75.0 / 255.0,139.0 / 255.0,            230.0 / 255.0,154.0 / 255.0,141.0 / 255.0,
    127.0 / 255.0,56.0 / 255.0,130.0 / 255.0,            206.0 / 255.0,74.0 / 255.0,126.0 / 255.0,
    0.0 / 255.0,177.0 / 255.0,210.0 / 255.0,            253.0 / 255.0,219.0 / 255.0,39.0 / 255.0,
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    ...
    case '1':
    {
        myLights[0].DiffuseColor.Set(colors[ind][0][0], colors[ind][0][1], colors[ind][0][2]);
        myLights[2].DiffuseColor.Set(colors[ind][1][0], colors[ind][1][1], colors[ind][1][2]);
        ind = (ind + 1) % 6;
        LoadAllLights();
    }

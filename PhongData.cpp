...
VectorR3 myLightPositions[3] = {
    VectorR3(-5.0, 8.0, 0.0),
    VectorR3(0.0, 8.0, 0.0),
    VectorR3(5.0, 8.0, 0.0),
};
...
void MySetupLights()
{
    ...
    myLights[1].AmbientColor.Set(0.0, 0.0, 0.0);    // Yellow color
    myLights[1].DiffuseColor.Set(0.0, 0.0, 0.0);    // Yellow
    myLights[1].SpecularColor.Set(0.0, 0.0, 0.0);   // White
...
void MySetupMaterials()
{
    ...
    myMaterials[0].AmbientColor.Set(0.4f, 0.4f, 0.4f);
    myMaterials[0].DiffuseColor.Set(0.9f, 0.9f, 0.9f);
